 $("#submit").click(function() {
   ...
   document.getElementById("result").style.opacity = 0; // make it flash off and on
    ...
    if (searchterm.indexOf("MKSAILTGLLFV") === 0 || searchterm.indexOf("MMKSAILTGLLFV") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/P12417"); 
    ...
    } else if (searchterm.indexOf("MSKGEELFTGVV") === 0 || searchterm.indexOf("MMSKGEELFTGVV") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/P42212");
    ...
    } else if (searchterm.indexOf("MENMENDENIV") === 0 || searchterm.indexOf("MMENMENDENIV") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/Q01158");
    ...
    } else if (searchterm.indexOf("MKLNKLNPRWDA") === 0 || searchterm.indexOf("MMKLNKLNPRWDA") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/Q8WTE7");
    ...
    } else if (searchterm.indexOf("MKTLLLTLVVVT") === 0 || searchterm.indexOf("MMKTLLLTLVVVT") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        d$(".protein-link").attr("href", "http://www.uniprot.org/uniprot/Q7T3J2");
    ...
    } else if (searchterm.indexOf("MAEPAKKKPKKL") === 0 || searchterm.indexOf("MMAEPAKKKPKKL") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/Q99285");
        document.getElementById("result-link").innerHTML = "Histone H2B";
        document.getElementById("protein-image").src = "img/6hb.png";
    } else if (searchterm.indexOf("MADKVLKEKR") === 0 || searchterm.indexOf("MMADKVLKEKR") === 0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/P29466");
        document.getElementById("result-link").innerHTML = "Caspase-1";
        document.getElementById("protein-image").src = "img/7cap.png";
    } else if (searchterm.indexOf("MEFTLRQEAL") ===  0 || searchterm.indexOf("MMEFTLRQEAL")===  0) {
        document.getElementById("result").style.opacity = 1;
        document.getElementById("sorry-message").style.opacity = 0;
        $(".protein-link").attr("href", "http://www.uniprot.org/uniprot/P93848");
